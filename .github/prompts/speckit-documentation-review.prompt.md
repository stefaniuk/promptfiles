...
- Capture every decision, rename, or identifier fix discovered here so that downstream prompts ([.github/prompts/speckit-code-review.prompt.md](.github/prompts/speckit-code-review.prompt.md) and [.github/prompts/speckit-test-review.prompt.md](.github/prompts/speckit-test-review.prompt.md)) inherit the corrected baseline when they compare code and tests against the specification set.
